...
import { discount, banking } from "../assets";
  ...
  <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
    ...
    >
      ...
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
        ...
        likely to fit your needs. We exemine annual percentage rates, annual
        fees.
      </p>
    </div>
    <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
      ...
      <div className="absolute z-[1] w-[70%] h-[40%] rounded-full pink__gradient bottom-40" />
